...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/chat` | `/chat` | `/(tabs)/diary` | `/diary` | `/(tabs)/` | `/(tabs)` | `/(tabs)/onboarding` | `/onboarding` | `/(tabs)/patterns` | `/patterns` | `/(tabs)/settings` | `/settings` | `/conversations/` | `/crisis` | `/cycle/` | `/diary/` | `/diary/new` | `/monthly-record/` | `/subscription`;
  // prettier-ignore
